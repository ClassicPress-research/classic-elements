...
/**
 * Classic Elements frontend.
 *
 * Classic Elements frontend handler class is responsible for initializing Classic Elements in
 * the frontend.
 *
 * @since 1.0.0
 */
class Frontend extends App {
	...
	/**
	 * Whether the page is using Classic Elements.
	 *
	 * Used to determine whether the current page is using Classic Elements.
	 *
	 * @since 1.0.0
	 * @access private
	 *
	 * @var bool Whether Classic Elements is being used. Default is false.
	 */
	 ...
	 * conflicted with Classic Elements while processing the content.
	 *
	 * @since 1.0.0
	 * @access private
	 *
	 ...
	 *
	 * Initializing Classic Elements front end. Make sure we are not in admin, not and
	 * redirect from old URL structure of Classic Elements editor.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	 ...
	 * Init.
	 *
	 * Initialize Classic Elements front end. Hooks the needed actions to run Classic Elements
	...
	public function init() {
		...
		// Add Edit with the Classic Elements in Admin Bar.
	 ...
	 * Add content filter.
	 *
	 * Remove plain content and render the content generated by Classic Elements.
	 *
	 * @since 1.8.0
	 * @access public
	 */
	 ...
	 *
	 * When the Classic Elements generated content rendered, we remove the filter to prevent multiple
	 * accuracies. This way we make sure Classic Elements renders the content only once.
	 *
	 * @since 1.8.0
	 * @access public
	 */
	...
	public function register_scripts() {
		 ...
		 *
		 * Fires before Classic Elements frontend scripts are registered.
		 *
		 * @since 1.2.1
		 */
		 ...
		 *
		 * Fires after Classic Elements frontend scripts are registered.
		 *
		 * @since 1.2.1
		 */
	...
	public function register_styles() {
		 ...
		 *
		 * Fires before Classic Elements frontend styles are registered.
		 *
		 * @since 1.2.0
		 */
		 ...
		 *
		 * Fires after Classic Elements frontend styles are registered.
		 *
		 * @since 1.2.0
		 */
	...
	public function enqueue_scripts() {
		 ...
		 *
		 * Fires before Classic Elements frontend scripts are enqueued.
		 *
		 * @since 1.0.0
		 */
		 ...
		 *
		 * Fires after Classic Elements frontend scripts are enqueued.
		 *
		 * @since 1.0.0
		 */
	...
	public function enqueue_styles() {
		 ...
		 *
		 * Fires before Classic Elements frontend styles are enqueued.
		 *
		 * @since 1.0.0
		 */
		...
		foreach ( $this->fonts_to_enqueue as $key => $font ) {
			...
			switch ( $font_type ) {
				...
				default:
					 ...
					 * Print font links.
					 *
					 * Fires when Classic Elements frontend fonts are printed on the HEAD tag.
					 *
	 ...
	 *
	 * Used to apply the Classic Elements page editor on the post content.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Used to render and return the post content with all the Classic Elements elements.
	 *
	...
	/**
	 * Add Classic Elements menu to admin bar.
	 *
	 * Add new admin bar item only on singular pages, to display a link that
	 * allows the user to edit with Classic Elements.
	 *
	...
	public function add_menu_in_admin_bar( \WP_Admin_Bar $wp_admin_bar ) {
		...
		$menu_args = [
			...
			'title' => __( 'Edit with Classic Elements', 'elementor' ),
		];
