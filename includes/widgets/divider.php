...
class Widget_Divider extends Widget_Base {
	...
	private function get_separator_styles() {
		return array_merge(
			...
			[
				'curly'   => [
					'label' => _x( 'Curly', 'shapes', 'elementor' ),
				...
				'curved'   => [
					'label' => _x( 'Curved', 'shapes', 'elementor' ),
				...
				'squared' => [
					'label' => _x( 'Squared', 'shapes', 'elementor' ),
				...
				'wavy'   => [
					'label' => _x( 'Wavy', 'shapes', 'elementor' ),
				...
				'zigzag'  => [
					'label' => _x( 'Zigzag', 'shapes', 'elementor' ),
				...
				'rhombus'   => [
					'label' => _x( 'Rhombus', 'shapes', 'elementor' ),
				...
				'parallelogram'   => [
					'label' => _x( 'Parallelogram', 'shapes', 'elementor' ),
				...
				'rounds_tribal'   => [
					'label' => _x( 'Half Rounds', 'shapes', 'elementor' ),
				...
				'leaves_tribal'   => [
					'label' => _x( 'Leaves', 'shapes', 'elementor' ),
				...
				'stripes_tribal'   => [
					'label' => _x( 'Stripes', 'shapes', 'elementor' ),
				...
				'trees_tribal'   => [
					'label' => _x( 'Trees', 'shapes', 'elementor' ),
